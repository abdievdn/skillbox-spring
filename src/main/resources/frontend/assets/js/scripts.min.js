                ...
                init: function () {
                    ...
                    $('.form_search').on('submit', function (e) {
                        ...
                        if (pageSearch) {
                            ...
                            getData('/search/page/' + $this.find('option:selected').val() + '/' + $this.find('.search-input').val(), {
                                offset: 0,
                                limit: $this.data('searchlimit')
                            });
                        } else {
                            window.location = '\/search\/' + $this.find('option:selected').val() +
        ...
        var Card = function () {
            var bookTemplate = function (book) {
                return '<div class="Card">' +
                    ...
                    '</div>' + '<div class="Card-content">\n' + '<strong class="Card-title"><a href="/books/' + book.slug + '">' +
                    book.title + '</a>\n' + '</strong>\n' + '<div class="Card-description">' +
                    book.authors.map(author => {
                        return author.lastName + ' ' + author.firstName;
                    }).join('</br>') +
                    (book.discount != 0 ? '<span class="Card-priceOld">₽' + book.discountPrice + '</span>\n' : '') +
                    ...
                    $('[data-refreshshow]').on('click change', function (e) {
                        ...
                        switch (data) {
                            ...
                            case 'tag':
                                ...
                                break;
                            case 'search':
                                getData('/search/page/' + $this.data('searchsource') + '/' + $this.data('refreshquery'), {
                                    offset: $this.data('refreshoffset'),
                                    limit: $this.data('refreshlimit')
                                });
                                break;
                ...
                init: function () {
                    ...
                    $sendButton.on('click', function (e) {
                        ...
                        if ($this.is('[data-send]')) {
                            ...
                            $this.data('send', {contact: contact, confirmation_type: 'signin'});
                            if (!error) {
                    ...
                    $entryButton.on('click', function (e) {
                        ...
                        if ($this.is('[data-send]')) {
                            ...
                            var contactType = $thisStep.attr('data-type');
                            var send = $this.data('send');
                            $this.data('send', {code: code, contact_type: contactType, contact: send.contact});
                            if (!error && $this.attr('id')) {
                ...
                init: function () {
                    ...
                    $btnSend.on('click', function (e) {
                        ...
                        if ($this.data('sendstatus') === 'ARCHIVED' && $this.data('check')) {
                            ...
                            Login().postData('/changeBookStatus' + $this.data('delete'), {
                                bookId: $this.data('bookid'),
                                status: status
                            }, function (result) {
                                if (result.result) {
                                ...
                                if ($(slick.$slides[slick.$slides.length - 3]).hasClass('slick-active')) {
                                    if ($(slick.$slider).data('load')) {
                                        ...
                                        switch ($(slick.$slider).data('load')) {
                                            case'recommended':
                                                sendData('/books/recommended/slider')
                                                break;
                                            case'recent':
                                                sendData('/books/recent/slider')
                                                break;
                                            case'popular':
                                                sendData('/books/popular/slider')
                                                break;
                                        }
                                    }
                                }
                ...
                init: function () {
                    $('form.Topup').on('submit', function (e) {
                        ...
                        Login().postData('/payment', {
                            ...
                            $('.Topup-wrap').append('<div class="form-group">' +
                            ...
                            $.ajax({
                                ...
                                complete: function (result) {
                                    if (result.status === 200) {
                                        ...
                                        $this.data('transactionoffset', $this.data('transactionoffset') + 1);
